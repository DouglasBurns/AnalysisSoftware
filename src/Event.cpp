...
namespace BAT {
	...
	double const Event::tightBTagWP_ = 0.935;
	...
	Event::Event() : //
			...
			passesElectronSelectionTightB_(false),
			passesElectronQCDSelectionTightB_(false),
			passesElectronConversionSelectionTightB_(false),
			passesMuonSelectionTightB_(false),
			passesMuonQCDSelection1p5to3TightB_(false),
			passesMuonQCDSelection3toInfTightB_(false),
	...
	const bool Event::PassesElectronSelectionTightB() const {
		if ( passesElectronSelectionTightB_ ) {
			return true;
		}
	...
	const bool Event::PassesElectronQCDSelectionTightB() const {
		if ( passesElectronQCDSelectionTightB_ ) {
			return true;
		}
	...
	const bool Event::PassesElectronConversionSelectionTightB() const {
		if ( passesElectronConversionSelectionTightB_ ) {
			return true;
		}
	...
	const bool Event::PassesMuonSelectionTightB() const {
		if ( passesMuonSelectionTightB_ ) {
			return true;
		}
	...
	const bool Event::PassesMuonQCDSelection1p5to3TightB() const {
		if ( passesMuonQCDSelection1p5to3TightB_ ) {
			return true;
		}
	...
	const bool Event::PassesMuonQCDSelection3toInfTightB() const {
		if ( passesMuonQCDSelection3toInfTightB_ ) {
			return true;
		}
	...
	const bool Event::PassesElectronTriggerAndSelectionTightB() const {
		if ( passesElectronSelectionTightB_ && passesElectronChannelTrigger_ ) {
			return true;
		}
	...
	const bool Event::PassesElectronTriggerAndQCDSelectionTightB() const {
		if ( passesElectronQCDSelectionTightB_ && passesElectronChannelTrigger_ ) {
			return true;
		}
	...
	const bool Event::PassesElectronTriggerAndConversionSelectionTightB() const {
		if ( passesElectronConversionSelectionTightB_ && passesElectronChannelTrigger_ ) {
			return true;
		}
	...
	const bool Event::PassesMuonTriggerAndSelectionTightB() const {
		if ( passesMuonSelectionTightB_ && (passesMuonChannelTrigger_ || passesTkMuonChannelTrigger_) ) {
			return true;
		}
	...
	const bool Event::PassesMuonTriggerAndQCDSelection1p5to3TightB() const {
		if ( passesMuonQCDSelection1p5to3TightB_ && (passesMuonChannelTrigger_ || passesTkMuonChannelTrigger_) ) {
			return true;
		}
	...
	const bool Event::PassesMuonTriggerAndQCDSelection3toInfTightB() const {
		if ( passesMuonQCDSelection3toInfTightB_ && (passesMuonChannelTrigger_ || passesTkMuonChannelTrigger_) ) {
			return true;
		}
	...
	void Event::setPassesElectronSelectionTightB( bool passesElectronSelectionTightB ) {
		passesElectronSelectionTightB_ = passesElectronSelectionTightB;
	}

	void Event::setPassesElectronQCDSelectionTightB( bool passesElectronQCDSelectionTightB ) {
		passesElectronQCDSelectionTightB_ = passesElectronQCDSelectionTightB;
	}

	void Event::setPassesElectronConversionSelectionTightB( bool passesElectronConversionSelectionTightB ) {
		passesElectronConversionSelectionTightB_ = passesElectronConversionSelectionTightB;
	}

	void Event::setPassesMuonSelectionTightB( bool passesMuonSelectionTightB ) {
		passesMuonSelectionTightB_ = passesMuonSelectionTightB;
	}

	void Event::setPassesMuonQCDSelection1p5to3TightB( bool passesMuonQCDSelection1p5to3TightB ) {
		passesMuonQCDSelection1p5to3TightB_ = passesMuonQCDSelection1p5to3TightB;
	}

	void Event::setPassesMuonQCDSelection3toInfTightB( bool passesMuonQCDSelection3toInfTightB ) {
		passesMuonQCDSelection3toInfTightB_ = passesMuonQCDSelection3toInfTightB;
	}
	...
	void Event::setPassOfflineSelectionInfo( std::vector<unsigned int> passSelections ) {
		...
		for ( unsigned int selection = 0; selection < passSelections.size(); ++selection ) {
			...
			if ( passSelections[selection] == 1 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesMuonSelectionTightB( true );
			}
			if ( passSelections[selection] == 2 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesElectronSelectionTightB( true );
			}
			if ( passSelections[selection] == 3 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesMuonQCDSelection1p5to3TightB( true );
			}
			if ( passSelections[selection] == 4 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesMuonQCDSelection3toInfTightB( true );
			}
			if ( passSelections[selection] == 5 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesElectronQCDSelectionTightB( true );
			}
			if ( passSelections[selection] == 6 && passesJetSelection( selectionCriteria ) && passesSignalLeptonSelection( selectionCriteria ) ){
				...
				if ( passesTightBJetSelection( selectionCriteria ) ) setPassesElectronConversionSelectionTightB( true );
			}
		}
	}
	...
	const bool Event::passesTightBJetSelection( const unsigned int selection ) { 
		...
		for ( unsigned int bJetIndex = 0; bJetIndex < bjets.size(); ++bJetIndex ) {
			const JetPointer bjet = bjets.at(bJetIndex);
			double bjetCSV = bjet->getBTagDiscriminator(BAT::BtagAlgorithm::value::CombinedSecondaryVertexV2);
			if ( bjet->pt() >= minJetPt_ && bjetCSV >= tightBTagWP_) ++nBJetPass;
		}
